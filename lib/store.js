...
const { withLocalSocketEntities, localSocketEntitiesRef } = entitiesPropsFactory("localSocket");
/**
...
export const store = createStore(
    ...
    withLocalSocketEntities({ idKey: ID_SYMBOL }),
    withActiveIds()
);
...
export const resetStore = (error) => {
    ...
    store.query(getAllEntities({ ref: interfacesEntitiesRef }))
        .forEach(o => idOf(o) === "lo" ? null : destroy(o.plex));
    ...
    store.update(
        ...
        deleteAllEntities({ ref: localSocketEntitiesRef })
    );
